...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 selection:bg-teal-500/30">
      {/* Navigation */}
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/80 backdrop-blur-lg border-b border-slate-200 py-3 shadow-sm' : 'bg-transparent py-5'}`}>
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
            ...
            <a href="#skala" className="hover:text-teal-600 transition-colors">Skalabilitas</a>
          </div>

          <div className="flex items-center gap-4">
            <button onClick={() => navigate('/daftar-ulang')} className="hidden sm:block text-sm font-semibold text-slate-600 hover:text-teal-600 transition-colors">
              Daftar Ulang
            </button>
            <button onClick={() => navigate('/login')} className="bg-slate-900 hover:bg-teal-700 text-white px-5 py-2.5 rounded-full text-sm font-semibold transition-all shadow-lg shadow-slate-900/20 hover:shadow-teal-700/30 flex items-center gap-2">
      ...
      <section id="beranda" className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-teal-100/50 border border-teal-200 text-teal-700 text-xs font-bold uppercase tracking-wider mb-8">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 tracking-tight leading-[1.1] max-w-4xl mb-6">
            Masa Depan Manajemen dengan <span className="text-teal-600">Teknologi Terkini</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <button onClick={() => navigate('/login')} className="px-8 py-4 bg-teal-700 hover:bg-teal-800 text-white rounded-full font-bold text-lg transition-all shadow-xl shadow-teal-700/30 hover:scale-105">
              Login Dashboard
            </button>
          ...
          <div className="mt-20 w-full max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-6 relative">
            ...
            <div className="bg-slate-900 p-8 rounded-3xl shadow-2xl shadow-slate-900/30 border border-slate-800 flex flex-col justify-center text-white relative overflow-hidden h-64 md:h-auto z-10 md:scale-110">
              <div className="absolute top-0 right-0 w-32 h-32 bg-teal-500/20 blur-2xl rounded-full"></div>
              <h3 className="text-xl font-bold mb-4">Total Cabang</h3>
              <div className="flex items-end gap-2 mb-2">
                <span className="text-5xl font-black">54+</span>
                <span className="text-teal-400 font-medium pb-1">Wilayah</span>
              </div>
      ...
      <section id="fitur" className="py-24 bg-[#0B2B26] text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-colors cursor-pointer group">
                <f.icon className="w-8 h-8 text-teal-400 mb-6 group-hover:scale-110 transition-transform" />
                <h3 className="text-xl font-bold mb-3">{f.title}</h3>
                <p className="text-teal-100/60 leading-relaxed">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="bg-white rounded-[2.5rem] shadow-2xl border border-slate-100 p-6 relative z-10">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  ...
                  <div className="w-1/4 h-8 bg-teal-100 rounded-full"></div>
                </div>
              ...
              <div className="absolute -bottom-10 -right-10 bg-white p-6 rounded-2xl shadow-xl border border-slate-100 w-64">
                ...
                <div className="flex items-end gap-2 h-24">
                  ...
                  <div className="w-1/4 bg-teal-600 rounded-t-lg h-[100%]"></div>
      ...
      <section id="skala" className="py-24 bg-[#0F172A] text-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="bg-slate-800 rounded-3xl p-8 border border-slate-700">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-3 text-sm text-slate-300"><CheckCircle className="w-4 h-4 text-teal-400" /> Manajemen Santri Internal</div>
                <div className="flex items-center gap-3 text-sm text-slate-300"><CheckCircle className="w-4 h-4 text-teal-400" /> Presensi Harian</div>
                <div className="flex items-center gap-3 text-sm text-slate-300"><CheckCircle className="w-4 h-4 text-teal-400" /> Pelaporan Dasar</div>
              </div>
            ...
            {/* Wilayah (Highlighted) */}
            <div className="bg-gradient-to-b from-teal-900 to-slate-900 rounded-3xl p-8 border border-teal-700 transform scale-105 shadow-2xl shadow-teal-900/50 relative">
              <div className="absolute top-0 right-8 -translate-y-1/2 bg-teal-500 text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide">Paling Ideal</div>
              <h3 className="text-2xl font-bold mb-2 text-teal-50">Level Wilayah</h3>
              <p className="text-teal-200/60 text-sm mb-6">Kontrol penuh atas seluruh cabang yang berada di bawah naungan wilayah.</p>
              
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-3 text-sm text-white"><CheckCircle className="w-4 h-4 text-teal-400" /> Akses Lintas Cabang</div>
                <div className="flex items-center gap-3 text-sm text-white"><CheckCircle className="w-4 h-4 text-teal-400" /> Manajemen Guru & Pegawai</div>
                <div className="flex items-center gap-3 text-sm text-white"><CheckCircle className="w-4 h-4 text-teal-400" /> Penjadwalan Akademik</div>
                <div className="flex items-center gap-3 text-sm text-white"><CheckCircle className="w-4 h-4 text-teal-400" /> Rekapitulasi Rapor Formal</div>
              </div>
              <button className="w-full py-3 rounded-xl bg-teal-600 text-white font-semibold hover:bg-teal-500 transition-colors">Login Dashboard</button>
            </div>
            ...
            <div className="bg-slate-800 rounded-3xl p-8 border border-slate-700">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-3 text-sm text-slate-300"><CheckCircle className="w-4 h-4 text-teal-400" /> Akses Global Seluruh Data</div>
                <div className="flex items-center gap-3 text-sm text-slate-300"><CheckCircle className="w-4 h-4 text-teal-400" /> Konfigurasi Sistem (Master)</div>
                <div className="flex items-center gap-3 text-sm text-slate-300"><CheckCircle className="w-4 h-4 text-teal-400" /> Tarik Data / Export-Import</div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-teal-400 transition-colors">Daftar Ulang Santri</a></li>
              <li><a href="#" className="hover:text-teal-400 transition-colors">FAQ & Bantuan</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><span className="hover:text-teal-400 transition-colors">Manajemen Santri</span></li>
              <li><span className="hover:text-teal-400 transition-colors">Absensi & Jurnal</span></li>
              <li><span className="hover:text-teal-400 transition-colors">Kepegawaian (HRD)</span></li>
            </ul>
          </div>
