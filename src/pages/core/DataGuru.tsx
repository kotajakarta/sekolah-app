          ...
          <div className="flex items-center gap-3">
            ...
            {(user?.scope === 'CABANG' || user?.scope === 'WILAYAH') && (
              ...
              >
                ...
                {user?.scope === 'CABANG' ? 'Penerimaan / Registrasi Guru' : t('guru.tarik_btn')}
              </button>
            )}
            <button
              type="button"
          ...
          <div className="bg-white p-3.5 rounded-2xl border border-slate-200/90 shadow-xs flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder={user?.scope === 'CABANG' ? "Cari nama guru, NIK, jabatan, mata pelajaran yang diampu..." : "Cari nama guru, NIK, jabatan, cabang, wilayah, mata pelajaran yang diampu..."}
                        ...
                        <tr key={item.id} className="hover:bg-slate-50 transition-colors">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-700">
                            <span className={`inline-flex rounded-full px-2.5 py-0.5 text-xs font-bold leading-5 ${
                              ...
                              {item.position === 'Kepala Cabang' && user?.scope === 'CABANG' ? 'Pimpinan Pesantren' : (item.position || '-')}
                            </span>
                          </td>
                          {user?.scope !== 'CABANG' && (
                            <>
