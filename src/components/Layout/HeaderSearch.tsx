    ...
    <>
      ...
      <div className="relative hidden lg:block w-full max-w-sm">
        ...
        <input
          ...
          className="w-full bg-slate-50 border border-slate-200 rounded-lg h-9 pl-9 pr-14 text-sm focus:outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-500/10 transition-colors"
        />
