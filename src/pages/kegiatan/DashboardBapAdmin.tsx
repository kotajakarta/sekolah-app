...
export default function DashboardBapAdmin() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      {/* SECTION: PROGRES DATA MASUK PER WILAYAH (Hidden for CABANG scope) */}
      {!isCabangScope && (
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-100 pb-4">
            <div>
              <h3 className="text-base font-extrabold text-slate-900 flex items-center gap-2">
                ...
                {activeTemplateObj && <span className="text-xs font-bold text-indigo-700 bg-indigo-50 px-2.5 py-0.5 rounded-lg border border-indigo-200">Filter: {activeTemplateObj.judul}</span>}
              </h3>
            ...
            <span className="text-xs font-bold text-slate-700 bg-slate-100 border border-slate-200 px-3 py-1 rounded-lg self-start sm:self-auto">
