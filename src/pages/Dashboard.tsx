        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col">
          ...
          <div className="flex items-end h-10 gap-0.5 w-full mt-4">
            {[30, 50, 40, 70, 90, 65, 80, 55, 60, 85].map((val, idx) => (
              <div
                key={idx}
                className="flex-1 bg-[#0051c3]/15 hover:bg-[#0051c3]/70 transition-colors duration-150 cursor-pointer rounded-sm"
                style={{ height: `${val}%` }}
              />
            ))}
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col">
          ...
          <div className="h-10 w-full mt-4 overflow-hidden relative">
            <svg className="w-full h-full" viewBox="0 0 100 40" preserveAspectRatio="none">
              ...
              <path d="M0,35 Q15,10 30,25 T60,15 T90,20 L100,25 L100,40 L0,40 Z" fill="rgba(0, 81, 195, 0.06)" />
            </svg>
          </div>
        </div>
                ...
                return (
                  <div key={i} className="flex flex-col items-center flex-1 h-full justify-end">
                    ...
                    <div className="w-full max-w-6 bg-slate-100 rounded-t-md flex flex-col justify-end overflow-hidden" style={{ height: '5.5rem' }}>
                      <div
                        className="w-full bg-[#0051c3] rounded-t-md transition-all duration-300"
                    ...
                    <tr key={cabang.cabangId} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="px-5 py-3.5 text-center">
                        <Link
                          ...
                          className="inline-flex items-center justify-center p-1.5 rounded-lg hover:bg-slate-100 text-[#0051c3] transition-colors"
          ...
          <div className="grid grid-cols-2 gap-2">
            {quickLinks.map((item, i) => (
              <Link
                to={item.path}
                key={i}
                className="group flex flex-col items-start gap-2 p-3 bg-slate-50 hover:bg-white border border-transparent hover:border-[#0051c3]/30 rounded-xl transition-colors"
              >
                <div className="p-1.5 rounded-lg bg-white border border-slate-200 text-slate-500 group-hover:text-[#0051c3] group-hover:border-[#0051c3]/30 transition-colors">
                  <item.icon className="w-4 h-4" />
                </div>
                <span className="text-xs font-semibold text-slate-700 group-hover:text-[#0051c3] transition-colors leading-tight">{item.label}</span>
              </Link>
            ))}
          </div>
        </div>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-5">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link
            ...
            className="text-[#0051c3] hover:text-[#00409c] text-xs font-medium flex items-center gap-0.5"
          >
